...
export async function calculateStockAtDate(
  ...
  // Get aggregate of all movements BEFORE the given date
  ...
  // We still fetch these individually as the volume is small and order matters relative to movementCreatedAt
