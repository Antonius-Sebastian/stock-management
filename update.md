...
* **User Story:** *As a Warehouse Operator, I want to register specific drums when receiving raw materials, so that I can track the exact stock levels of each physical container.*
* **Specifications:**
...
* **User Story:** *As a Production Staff, I want to record material usage by selecting specific drums, so that the system knows exactly which container was used for which batch.*
* **Specifications:**
...
* **User Story:** *As a Production Supervisor, I want a dedicated button to manually input finished good stock, so that production output can be recorded independently of the raw material batch process.*
* **Specifications:**
...
* **User Story:** *As an Admin, I want to adjust drum stock or delete batches, so that the physical and digital inventory stay synchronized in case of errors.*
* **Specifications:**
...
* **User Story:** *As an Inventory Manager, I want to see a report of stock movements filtered by Drum ID, so that I can investigate discrepancies in specific containers.*
* **Specifications:**
